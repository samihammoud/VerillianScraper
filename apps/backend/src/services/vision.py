...
CLAIM_BATCH_SIZE = 2500  # ponytail: covers the ~2000 videos currently on disk; revert to 200 for steady-state crawl passes
...
def describe_posts() -> int:
    ...
    _mark_attempted([c["id"] for c in candidates])
